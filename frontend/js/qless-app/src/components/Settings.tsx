    ...
    <Dialog open={closeSettings} fullWidth maxWidth="md">
      <DialogTitle>
        <Stack direction="row" justifyContent="end" spacing={25}>
          ...
          <Stack direction="row">
            <Button sx={{ color: "black" }} onClick={handleClickCloseSettings}>
              <CloseIcon />
            </Button>
          </Stack>
        </Stack>
      ...
      <DialogContent dividers>
        <Stack direction="row" spacing={1}>
          <Stack direction="column" spacing={1} paddingLeft="20px">
            <Typography variant="h6" fontFamily="monospace" fontSize={35}>
              Profile
            </Typography>
            <Typography variant="body1" fontFamily="monospace" fontSize={20}>
              First name
            </Typography>
            <Stack direction="row" spacing={1}>
              <TextField
                ...
                sx={{ width: "250px" }}
              ></TextField>
              <Button sx={{ color: "black" }} onClick={handleEditFnButton}>
                <ModeEditIcon />
              </Button>
            </Stack>
            <Typography
            ...
            <Stack direction="row" spacing={1}>
              <TextField
                ...
                sx={{ width: "250px" }}
              ></TextField>
              <Button sx={{ color: "black" }} onClick={handleEditLnButton}>
                <ModeEditIcon />
              </Button>
            </Stack>
            <p />
            <Typography variant="h6" fontFamily="monospace" fontSize={20}>
              Email
            </Typography>
            <Stack direction="row" spacing={1}>
              <TextField
